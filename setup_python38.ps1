# Script para baixar e instalar Python 3.8 automaticamente
# Python 3.8 é a versão mais compatível com ML-Agents 0.28.0
...
Write-Host "  Instalando Python 3.8 para ML-Agents" -ForegroundColor Green
Write-Host "======================================" -ForegroundColor Green
Write-Host ""

# Verificar se Python 3.8 já está instalado
if (Test-Path "$targetDir\python.exe") {
    Write-Host "Python 3.8 já está instalado em $targetDir" -ForegroundColor Green
    Write-Host ""
...
# Baixar o instalador
Write-Host "Baixando Python 3.8..." -ForegroundColor Cyan
...
try {
    ...
    Write-Host "ERRO: Falha ao baixar Python 3.8" -ForegroundColor Red
...
Write-Host ""
Write-Host "Instalando Python 3.8 em $targetDir..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "======================================" -ForegroundColor Green
Write-Host "  Python 3.8 Instalado com Sucesso!" -ForegroundColor Green
Write-Host "======================================" -ForegroundColor Green
Write-Host ""
